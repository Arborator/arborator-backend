...
def validate_ud(lang, level, data):
    ...
    stderr_output = sys.stderr.getvalue()  # khensa: capture the stderr output
    ...
    sys.stderr = temp_stderr  # khensa: restore stderr to its original state
    return stderr_output, passed  # khensa: return the captured stderr output for further processing if needed



if __name__ == "__main__":
    # This is the main entry point for the script.
    # It will be called when the script is run directly.
    # The script can also be imported as a module, in which case this part will not be executed.
    validate_ud(*sys.argv)  # Example call; replace with actual language and level as needed.
