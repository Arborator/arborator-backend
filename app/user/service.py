    ...
    def create_or_update_user(parsed_user_info: dict):
        ...
        if not user:
            ...
            new_attrs: UserInterface = {
                ...
                "first_name": parsed_user_info["first_name"] if "first_name" in parsed_user_info.keys() else "",
                "family_name": parsed_user_info["family_name"] if "family_name" in parsed_user_info.keys() else "",
